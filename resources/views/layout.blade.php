...
<footer>
    <div class="container" style="margin-top: 5rem">
        <footer style="    flex-direction: column;" class="col d-flex flex-wrap  justify-content-between align-items-center py-3 my-4 border-top">
            <p class="mb-md-0 text-muted" style="margin-bottom: 2rem">©2024, Dostavochkin. Все права защищены.</p>
            ...
            <div>
                <div class="text-secondary col-11"  style=" font-size: 25px; text-align:center">КЛИЕНТАМ</div>
                <ul class="nav col-11 justify-content-center" style=" font-size: 18px">
            ...
            <p class="text fw-light" style=" margin-top: 3rem">Наши cоцальные сети:</p>
            <ul style="justify-content:space-evenly; padding-left:0",class="nav col-md-4 list-unstyled d-flex" >
