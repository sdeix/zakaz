...
@section('main-content')
    <div class="row mb-2 justify-content-center mb-md-0 col-12" style="padding-top: 5px; height: 300px; font-size: 18px; margin-right: 5rem" >
        <div style="height:100%" class="col-auto">
            <div style="flex-wrap: nowrap;height:100% "class="row g-0 border rounded  flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                ...
                <div style="height:100%; width:auto", class="    d-lg-block">
                    <img class="bd-placeholder-img" height="100%"  xmlns="http://www.w3.org/2000/svg" role="img" src="/images/lovekont.jpg">
                </div>
            </div>
        </div>
    </div>
    <div class="container px-4 py-5" id="icon-grid" style="margin-top: 0.5rem">
        <h2 class="pb-2 border-bottom col-11" style="text-align: center;"><ya-tr-span data-index="23-0" data-translated="true" data-source-lang="en" data-target-lang="ru" data-value="Icon grid" data-translation="Сетка значков" data-ch="0" data-type="trSpan">В ДВУХ СЛОВАХ О НАШЕМ СЕРВИСЕ</ya-tr-span></h2>

        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 py-5" style="justify-content: space-evenly;">
